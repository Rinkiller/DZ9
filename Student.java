...
public class Student {
    ...
    public Student(String name, Map<LocalDate, Boolean> passportsAndNames) {
        this.name = name;
        this.attendance = passportsAndNames;
    }
    ...
    public String toString() {
        return "Student [name=" + name + ", passportsAndNames=" + attendance + "]";
    }
